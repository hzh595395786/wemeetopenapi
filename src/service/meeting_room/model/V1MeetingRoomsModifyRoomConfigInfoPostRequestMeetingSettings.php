...
class V1MeetingRoomsModifyRoomConfigInfoPostRequestMeetingSettings implements ModelInterface, \JsonSerializable
{
    ...
    public function roomPmiSettings(\wemeet\openapi\service\meeting_room\model\V1MeetingRoomsModifyRoomConfigInfoPostRequestMeetingSettingsRoomPmiSettings $roomPmiSettings): V1MeetingRoomsModifyRoomConfigInfoPostRequestMeetingSettings {
    ...
    public function setRoomPmiSettings(\wemeet\openapi\service\meeting_room\model\V1MeetingRoomsModifyRoomConfigInfoPostRequestMeetingSettingsRoomPmiSettings $roomPmiSettings) {
        $this->roomPmiSettings = $roomPmiSettings;
    }
