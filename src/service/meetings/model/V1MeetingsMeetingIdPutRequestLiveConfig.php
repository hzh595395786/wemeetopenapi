...
class V1MeetingsMeetingIdPutRequestLiveConfig implements ModelInterface, \JsonSerializable
{
    ...
    public function liveWatermark(\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark $liveWatermark): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function setLiveWatermark(\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark $liveWatermark) {
        $this->liveWatermark = $liveWatermark;
    }
