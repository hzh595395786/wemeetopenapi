...
class V1MeetingsMeetingIdGet200ResponseMeetingInfoListInnerLiveConfig implements ModelInterface, \JsonSerializable
{
    ...
    public function liveWatermark(\wemeet\openapi\service\meetings\model\V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfigLiveWatermark $liveWatermark): V1MeetingsMeetingIdGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function setLiveWatermark(\wemeet\openapi\service\meetings\model\V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfigLiveWatermark $liveWatermark) {
        $this->liveWatermark = $liveWatermark;
    }
