...
class V1RealControlMeetingsMeetingIdScreenSharedPutRequest implements ModelInterface, \JsonSerializable
{
    ...
    public function user(\wemeet\openapi\service\meeting_control\model\V1RealControlMeetingsMeetingIdScreenSharedPutRequestUser $user): V1RealControlMeetingsMeetingIdScreenSharedPutRequest {
        $this->user = $user;
        return $this;
    }
    ...
    public function setUser(\wemeet\openapi\service\meeting_control\model\V1RealControlMeetingsMeetingIdScreenSharedPutRequestUser $user) {
        $this->user = $user;
    }
